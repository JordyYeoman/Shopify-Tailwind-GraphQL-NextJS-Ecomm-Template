                    ...
                    {navigation.categories.map((category) => (
                      <Tab
                        ...
                        className={({ selected }) =>
                          classNames(
                            selected
                              ? "text-primary-600 border-indigo-600"
            ...
            <div className="h-16 flex items-center">
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                open
                                  ? "border-indigo-600 text-primary-600"
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a
                    href="#"
                    className="text-gray-700 hover:text-gray-800 flex items-center  z-0 rounded-lg shadow-light"
                  >
                    <img
                      src="https://tailwindui.com/img/flags/flag-australia.svg"
                      alt=""
                      className="w-5 h-auto block flex-shrink-0 z-10"
                    />
